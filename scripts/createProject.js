// Sample Input - npm run createProject --name=InstagramCLI --title='InstagramCLI' ..... Use this to make new project
...
if (!n) {
  console.error('Please provide a project name: npm run createProject --name=MyApp --title="My App"');
  process.exit(1);
}
